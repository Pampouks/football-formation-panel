...
export function BoardToolsPanel(props: Props) {
  ...
  return <aside className="tools-panel panel-card">
    <div><p className="eyebrow">Board tools</p><h2>Style & export</h2><p className="panel-copy">Style the kit markers, save your board locally, or export the current tactics board as a PNG.</p></div>
