...
export function TacticsBoard() {
  ...
  const [playerPositionsLocked, setPlayerPositionsLocked] = useState(false);
  ...
  const saveBoard = () => {
    saveBoardState({ mode, playerPoolType, selectedPoolId, formationId, formationCoordinates, activeRoleIndex, cameraAngle, cameraView, cameraLocked, playerPositionsLocked, markerScale, kitHue, kitMode, customKitPattern, customKitPrimaryHue, customKitSecondaryHue, showPlayerLabels, pitchLineOpacity, customBoardImageUrl, customKitImageUrl, selectedIds, boardPlayers });
  ...
  const loadBoard = () => {
    ...
    setPlayerPositionsLocked(saved.playerPositionsLocked ?? false);
