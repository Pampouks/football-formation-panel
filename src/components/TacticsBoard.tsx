...
export function TacticsBoard() {
  ...
  return <main className="app-shell">
    ...
    <ControlPanel mode={mode} playerPoolType={playerPoolType} selectedPoolId={selectedPoolId} clubs={clubs} leagues={leagues} nationalTeams={nationalTeams} players={players} boardPlayers={boardPlayers} formationCoordinates={formationCoordinates} activeRoleIndex={activeRoleIndex} formationId={formationId} selectedIds={selectedIds} onModeChange={changeMode} onPoolTypeChange={changePoolType} onPoolChange={changePool} onFormationChange={changeFormation} onSpotSelect={setActiveRoleIndex} onLoadExampleTeam={loadExampleTeam} onTogglePlayer={togglePlayer} />
