...
export function TacticsBoard() {
  ...
  const nudgeCamera = (delta: Partial<CameraView>) => { setCameraAngle('isometric'); setCameraView((current) => clampCameraView({ ...current, ...delta })); setStatus('Camera adjusted.'); };
