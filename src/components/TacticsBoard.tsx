...
export function TacticsBoard() {
  ...
  const changeCameraAngle = (angle: CameraAngle) => { setCameraAngle(angle); setStatus(`${angle[0].toUpperCase()}${angle.slice(1)} camera angle selected.`); };
  ...
  const saveBoard = () => {
    saveBoardState({ mode, playerPoolType, selectedPoolId, formationId, cameraAngle, selectedIds, boardPlayers });
